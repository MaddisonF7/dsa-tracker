    ...
    if 'user' in session:
        ...
        try:
            ...
            if table_name == 'User':
                ...
                if role == 'Admin':
                    cur.execute("SELECT COUNT(*) FROM User WHERE line_manager_id = %s", (record_id,))
            ...
            if table_name == 'User' and role == 'Apprentice':
                ...
                cur.execute("DELETE FROM Leave_request WHERE apprentice_id = %s", (record_id,))
                cur.execute("DELETE FROM Project WHERE apprentice_id = %s", (record_id,))
                mysql.connection.commit()
                cur.close()
