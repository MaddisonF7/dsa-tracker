...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.body.addEventListener('click', (event) => {
        if (event.target && event.target.classList.contains('logout-button')) {
            console.log('Logout button clicked:', event.target);
    ...
    // Hide Flash notifications after five seconds
    ...
    // Toggle apprentice fields visibility based on the role selected
